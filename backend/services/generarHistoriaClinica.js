...
async function generarHistoriaClinicaDocx(data) {
  try {
    ...
    const templatePath = path.join(__dirname, '../templates/HISTORIA CLINICA MODIFICADA (2).docx');
    ...
    const docData = {
      ...
      // Antecedentes Familiares - Detalles por antecedente
      tuberculosis_abuelos: data.antFamiliares?.["Tuberculosis"]?.abuelos ? "SI" : "NO",
      tuberculosis_abuelos_genero: data.antFamiliares?.["Tuberculosis"]?.abuelosGenero || "",
      tuberculosis_abuelos_linea: data.antFamiliares?.["Tuberculosis"]?.abuelosLinea || "",
      tuberculosis_abuelos_finado: data.antFamiliares?.["Tuberculosis"]?.abuelosFinado ? "SI" : "NO",
      tuberculosis_padres: data.antFamiliares?.["Tuberculosis"]?.padres ? "SI" : "NO",
      tuberculosis_padres_genero: data.antFamiliares?.["Tuberculosis"]?.padresGenero || "",
      tuberculosis_padres_finado: data.antFamiliares?.["Tuberculosis"]?.padresFinado ? "SI" : "NO",

      sifilis_abuelos: data.antFamiliares?.["Sífilis"]?.abuelos ? "SI" : "NO",
      sifilis_abuelos_genero: data.antFamiliares?.["Sífilis"]?.abuelosGenero || "",
      sifilis_abuelos_linea: data.antFamiliares?.["Sífilis"]?.abuelosLinea || "",
      sifilis_abuelos_finado: data.antFamiliares?.["Sífilis"]?.abuelosFinado ? "SI" : "NO",
      sifilis_padres: data.antFamiliares?.["Sífilis"]?.padres ? "SI" : "NO",
      sifilis_padres_genero: data.antFamiliares?.["Sífilis"]?.padresGenero || "",
      sifilis_padres_finado: data.antFamiliares?.["Sífilis"]?.padresFinado ? "SI" : "NO",

      hipertension_abuelos: data.antFamiliares?.["Hipertensión"]?.abuelos ? "SI" : "NO",
      hipertension_abuelos_genero: data.antFamiliares?.["Hipertensión"]?.abuelosGenero || "",
      hipertension_abuelos_linea: data.antFamiliares?.["Hipertensión"]?.abuelosLinea || "",
      hipertension_abuelos_finado: data.antFamiliares?.["Hipertensión"]?.abuelosFinado ? "SI" : "NO",
      hipertension_padres: data.antFamiliares?.["Hipertensión"]?.padres ? "SI" : "NO",
      hipertension_padres_genero: data.antFamiliares?.["Hipertensión"]?.padresGenero || "",
      hipertension_padres_finado: data.antFamiliares?.["Hipertensión"]?.padresFinado ? "SI" : "NO",

      diabetes_abuelos: data.antFamiliares?.["Diabetes"]?.abuelos ? "SI" : "NO",
      diabetes_abuelos_genero: data.antFamiliares?.["Diabetes"]?.abuelosGenero || "",
      diabetes_abuelos_linea: data.antFamiliares?.["Diabetes"]?.abuelosLinea || "",
      diabetes_abuelos_finado: data.antFamiliares?.["Diabetes"]?.abuelosFinado ? "SI" : "NO",
      diabetes_padres: data.antFamiliares?.["Diabetes"]?.padres ? "SI" : "NO",
      diabetes_padres_genero: data.antFamiliares?.["Diabetes"]?.padresGenero || "",
      diabetes_padres_finado: data.antFamiliares?.["Diabetes"]?.padresFinado ? "SI" : "NO",

      cardiopatas_abuelos: data.antFamiliares?.["Cardiópatas"]?.abuelos ? "SI" : "NO",
      cardiopatas_abuelos_genero: data.antFamiliares?.["Cardiópatas"]?.abuelosGenero || "",
      cardiopatas_abuelos_linea: data.antFamiliares?.["Cardiópatas"]?.abuelosLinea || "",
      cardiopatas_abuelos_finado: data.antFamiliares?.["Cardiópatas"]?.abuelosFinado ? "SI" : "NO",
      cardiopatas_padres: data.antFamiliares?.["Cardiópatas"]?.padres ? "SI" : "NO",
      cardiopatas_padres_genero: data.antFamiliares?.["Cardiópatas"]?.padresGenero || "",
      cardiopatas_padres_finado: data.antFamiliares?.["Cardiópatas"]?.padresFinado ? "SI" : "NO",

      renales_abuelos: data.antFamiliares?.["Renales"]?.abuelos ? "SI" : "NO",
      renales_abuelos_genero: data.antFamiliares?.["Renales"]?.abuelosGenero || "",
      renales_abuelos_linea: data.antFamiliares?.["Renales"]?.abuelosLinea || "",
      renales_abuelos_finado: data.antFamiliares?.["Renales"]?.abuelosFinado ? "SI" : "NO",
      renales_padres: data.antFamiliares?.["Renales"]?.padres ? "SI" : "NO",
      renales_padres_genero: data.antFamiliares?.["Renales"]?.padresGenero || "",
      renales_padres_finado: data.antFamiliares?.["Renales"]?.padresFinado ? "SI" : "NO",

      epilepticos_abuelos: data.antFamiliares?.["Epilépticos"]?.abuelos ? "SI" : "NO",
      epilepticos_abuelos_genero: data.antFamiliares?.["Epilépticos"]?.abuelosGenero || "",
      epilepticos_abuelos_linea: data.antFamiliares?.["Epilépticos"]?.abuelosLinea || "",
      epilepticos_abuelos_finado: data.antFamiliares?.["Epilépticos"]?.abuelosFinado ? "SI" : "NO",
      epilepticos_padres: data.antFamiliares?.["Epilépticos"]?.padres ? "SI" : "NO",
      epilepticos_padres_genero: data.antFamiliares?.["Epilépticos"]?.padresGenero || "",
      epilepticos_padres_finado: data.antFamiliares?.["Epilépticos"]?.padresFinado ? "SI" : "NO",

      atopicos_abuelos: data.antFamiliares?.["Atópicos"]?.abuelos ? "SI" : "NO",
      atopicos_abuelos_genero: data.antFamiliares?.["Atópicos"]?.abuelosGenero || "",
      atopicos_abuelos_linea: data.antFamiliares?.["Atópicos"]?.abuelosLinea || "",
      atopicos_abuelos_finado: data.antFamiliares?.["Atópicos"]?.abuelosFinado ? "SI" : "NO",
      atopicos_padres: data.antFamiliares?.["Atópicos"]?.padres ? "SI" : "NO",
      atopicos_padres_genero: data.antFamiliares?.["Atópicos"]?.padresGenero || "",
      atopicos_padres_finado: data.antFamiliares?.["Atópicos"]?.padresFinado ? "SI" : "NO",

      alturas_abuelos: data.antFamiliares?.["Alturas"]?.abuelos ? "SI" : "NO",
      alturas_abuelos_genero: data.antFamiliares?.["Alturas"]?.abuelosGenero || "",
      alturas_abuelos_linea: data.antFamiliares?.["Alturas"]?.abuelosLinea || "",
      alturas_abuelos_finado: data.antFamiliares?.["Alturas"]?.abuelosFinado ? "SI" : "NO",
      alturas_padres: data.antFamiliares?.["Alturas"]?.padres ? "SI" : "NO",
      alturas_padres_genero: data.antFamiliares?.["Alturas"]?.padresGenero || "",
      alturas_padres_finado: data.antFamiliares?.["Alturas"]?.padresFinado ? "SI" : "NO",

      confinados_abuelos: data.antFamiliares?.["Confinados"]?.abuelos ? "SI" : "NO",
      confinados_abuelos_genero: data.antFamiliares?.["Confinados"]?.abuelosGenero || "",
      confinados_abuelos_linea: data.antFamiliares?.["Confinados"]?.abuelosLinea || "",
      confinados_abuelos_finado: data.antFamiliares?.["Confinados"]?.abuelosFinado ? "SI" : "NO",
      confinados_padres: data.antFamiliares?.["Confinados"]?.padres ? "SI" : "NO",
      confinados_padres_genero: data.antFamiliares?.["Confinados"]?.padresGenero || "",
      confinados_padres_finado: data.antFamiliares?.["Confinados"]?.padresFinado ? "SI" : "NO",
      // antPatologicos: data.antPatologicos || {},
      ets: data.antPatologicos?.["ETS"]?.["si"] == true ? "SI" : "NO",
      ...
      cardiopatas: data.antPatologicos?.["Cardiopatías"]?.["si"] == true ? "SI" : "NO",
      ...
      psiquiatricos: data.antPatologicos?.["Psiquiátricos"]?.["si"] == true ? "SI" : "NO",
      medicamentos: data.antPatologicos?.["Medicamentos / Controlados"]?.["si"] == true ? "SI" : "NO",
      alturas: data.antPatologicos?.["Alturas"]?.["si"] == true ? "SI" : "NO",
      confinados: data.antPatologicos?.["Confinados"]?.["si"] == true ? "SI" : "NO",
      ...
      toxicomanias: data.antNoPatologico?.toxicomanias == true ? 'SI' : (data.antNoPatologico?.toxicomanias == false ? 'NO' : ''),
      toxicomaniasEsp: s(data.antNoPatologico?.toxicomaniasEsp),
      alcoholismo: data.antNoPatologico?.alcoholismo == true ? 'SI' : (data.antNoPatologico?.alcoholismo == false ? 'NO' : ''),
      alcoholismoEsp: s(data.antNoPatologico?.alcoholismoEsp),
      tabaquismo: data.antNoPatologico?.tabaquismo == true ? 'SI' : (data.antNoPatologico?.tabaquismo == false ? 'NO' : ''),
      tabaquismoEsp: s(data.antNoPatologico?.tabaquismoEsp),
      miopia: (data.miopia || data.AgudezaVisual?.miopia) ? 'SI' : 'NO',
      astigmatismo: (data.astigmatismo || data.AgudezaVisual?.astigmatismo) ? 'SI' : 'NO',
      presbicia: (data.presbicia || data.AgudezaVisual?.presbicia) ? 'SI' : 'NO',
      ...
      oidos_antecedentes_patologico: data.expOidos?.['Antecedentes']?.valor == "Normal" ? "X" : "",
      oidos_antecedentes_traumatico: data.expOidos?.['Antecedentes']?.descripcion == "traumatico" ? "X" : "",
      ...
      resultadoB: data.conclusiones?.resultado == "Bueno" ? "X" : "",
      resultadoR: data.conclusiones?.resultado == "Regular" ? "X" : "",
      resultadoM: data.conclusiones?.resultado == "Malo" ? "X" : "",
      // gradoSalud: data.conclusiones?.gradoSalud || '',
      gradoSaludS: data.conclusiones?.gradoSalud == "Sano" ? "X" : "",
      gradoSaludM: data.conclusiones?.gradoSalud == "R. Moderado" ? "X" : "",
      gradoSaludA: data.conclusiones?.gradoSalud == "R. Alto" ? "X" : "",
      // observaciones: data.conclusiones?.observaciones || '',
      observacionesA: data.conclusiones?.observaciones == "Apto" ? "X" : "  ",
      observacionesN: data.conclusiones?.observaciones == "No Apto" ? "X" : "  ",
    };
